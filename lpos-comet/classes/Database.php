...
class Database {
	...
	public function prepareInsert($data, $table): bool|PDOStatement {
	...
	public function prepareRead($table, $columns, $where='', $limit=''): bool|PDOStatement {
	 ...
	 */
	public function prepareUpdate($table, $data, $where): bool|PDOStatement {
	...
	public function prepareDelete($table, $where): bool|PDOStatement {
	...
	public function query($query): bool|string|PDOStatement {
		$statement = "";
		if(!empty($query)){
			$statement = $this->connection->prepare($query);
		}
	...
	private function processWhere($where, &$placeholders): string {
		$string = '';
